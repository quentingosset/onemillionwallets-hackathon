                      ...
                      AppButton.buildAppButton(
                        ...
                        if (await validateForm()) {
                          ...
                          Account newAccount = Account(
                              network: int.parse(StateContainer.of(context).selectedNetworkAddAccount),
                              address: widget.address == null
                                  ? _addressController.text
                                  : widget.address);
                          await sl.get<DBHelper>().saveAccount(newAccount);
                          await StateContainer.of(context).updateWallet(account: newAccount);
                          /*EventTaxiImpl.singleton().fire(
                              ContactAddedEvent(contact: newContact));*/
