...
class _ContactsListState extends State<ContactsList> {
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  ListView.builder(
                    ...
                    itemCount: StateContainer.of(context).walletsMap.length,
                    itemBuilder: (context, index) {
                      // Build contact
                      return _buildSingleContact(context, StateContainer.of(context).walletsMap.values.toList()[index]);
                    },
                  ),
            ...
            CountryListPick(
              // To disable option set to false
                theme: CountryTheme(
                  ...
                  alphabetSelectedBackgroundColor: StateContainer.of(context).curTheme.background,
                ...
                onChanged: (CountryCode code) {
                        ...
                        print(code.flagUri);
                        setState(() {
                          StateContainer.of(context).selectedNetworkAddAccount = code.code;
                        });
                      },
  ...
  Widget _buildSingleContact(BuildContext context, AppWallet wallet) {
    return FlatButton(
      ...
      child: Column(children: <Widget>[
        ...
        Container(
          ...
          child: Row(
            ...
            children: <Widget>[
                Image(
                image :  AssetImage("assets/${wallet.network}.png"), width: 28,
                  height: 28,
                  color: null),
              //Contact info
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    //Contact name
                    Text(Util.getNetworkName(wallet.network),
