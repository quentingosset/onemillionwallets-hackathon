...
class AvalancheTheme extends BaseTheme {
  static const purple = Color(0xFFe84242);
...
enum AppIconEnum { AVALANCHE, DEFAULT, KALIUM, TITANIUM, IRIDIUM, BERYLLIUM, RADIUM }
class AppIcon {
  ...
  static Future<void> setAppIcon(AppIconEnum iconToChange) async {
    ...
    switch (iconToChange) {
      ...
      case AppIconEnum.KALIUM:
        iconStr = "kalium";
        break;
      case AppIconEnum.AVALANCHE:
        iconStr = "avalanche";
        break;
      case AppIconEnum.DEFAULT:
      default:
        iconStr = "default";
        break;
    }
