...
class AppLocalization {
  ...
  String get portefolio {
    return Intl.message('Portefolio',
        desc: 'portefolio_header', name: 'portefolio');
  }

  String get transactionList {
    return Intl.message('Transaction lists',
        desc: 'transaction_lists', name: 'transaction_lists');
  }
  ...
  String get accountsHeader {
    return Intl.message('Accounts',
        desc: 'accounts_header', name: 'accountsHeader');
  }
  ...
  String get welcomeTextKal {
    return Intl.message("Welcome to Avalanche Wallet. To begin you may create a new wallet or import an existing one.",
        desc: 'intro_welcome_title', name: 'welcomeTextKal');
  }

  String get welcomeText {
    return Intl.message("Welcome to OneMillionWallets.\nTo begin you may add your public address of BSC / ETH / AVAX.",
  ...
  String get nameCompany {
    return Intl.message("OneMillionWallet - Hackathon",
        desc: 'onemillionwallets', name: 'OneMillionWallet');
  }

  String get shareOnemillionwallets {
    return Intl.message("Share OneMillionWallets",
      desc: 'onemillionwallets_share', name: 'shareOnemillionwallets');
  }
  ...
  String get exampleCardIntroKal {
    return Intl.message("Welcome to Avalanche Wallet. all your Avalanche assets will listed below :",
  ...
  String get creatAccountHint {
    return Intl.message("Please select your network and enter your public address.",
        desc: 'Please select your network and enter your public address', name: 'creatAccountHint');
  }
  ...
  String get AddressSizeError {
    return Intl.message("Address can't be empty",
        desc: 'err', name: 'AddressSizeError');
  }
 ...
 /// PARAGRAPS
  ...
  String getNftUrl(String account) {
    return account.replaceAll('http://', 'https://');
  }
