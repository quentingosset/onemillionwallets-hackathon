...
import 'package:kalium_wallet_flutter/ui/home_page2.dart';
...
import 'package:kalium_wallet_flutter/ui/portefolio_tokens_page.dart';
          ...
          switch (settings.name) {
            ...
            case '/home_transition':
              return NoPopTransitionRoute(
                builder: (_) => PortefolioTokensPage(),
                settings: settings,
              );
            case '/intro_welcome':
              return NoTransitionRoute(
