...
@JsonSerializable()
class AccountsBalancesHistoryResponse {
  Map<String, double> history;

  AccountsBalancesHistoryResponse({this.history});

  factory AccountsBalancesHistoryResponse.fromJson(Map<String, dynamic> json) => _$AccountsBalancesHistoryResponseFromJson(json);
  //Map<String, dynamic> toJson() => _$AccountsBalancesHistoryResponseToJson(this);
}