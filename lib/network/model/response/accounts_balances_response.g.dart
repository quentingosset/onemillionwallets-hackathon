...
AccountsBalancesHistoryResponse _$AccountsBalancesHistoryResponseFromJson(
    Map<String, dynamic> json) {
  return AccountsBalancesHistoryResponse(
    history: (json['balances'] as Map<String, dynamic>)?.map(
          (k, e) => MapEntry(
          k,
          e == null
              ? null
...
/*Map<String, dynamic> _$AccountsBalancesHistoryResponseToJson(
        AccountsBalancesResponse instance) =>
    <String, dynamic>{
      'balances': instance.balances,
    };*/
